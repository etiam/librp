...
//    virtual void    Attribute(RtToken name, RtInt n, RtToken nms[], RtPointer vals[], RtInt lengths[]);
    ...
    virtual void    Display(RtToken, RtToken, RtToken, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    ...
    virtual void    Hider(RtToken, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    virtual void    Format(RtInt, RtInt, RtFloat);
    virtual void    FrameAspectRatio(RtFloat);
    virtual void    LightSource(RtToken, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    virtual void    NuPatch(RtInt, RtInt, RtFloat[], RtFloat, RtFloat, RtInt, RtInt, RtFloat[], RtFloat, RtFloat, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    virtual void    Matte(bool onoff);
    virtual void    Option(RtToken, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    ...
    virtual void    Polygon(RtInt, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    virtual void    Projection(RtToken, RtInt, RtToken[], RtPointer vals[], RtInt[]);
    ...
    virtual void    Surface(RtToken, RtInt, RtToken[], RtPointer vals[], RtInt[]);
